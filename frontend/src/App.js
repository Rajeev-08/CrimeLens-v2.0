...
function App() {
    // VIEW STATE: 'welcome', 'features', 'docs', 'dashboard'
            ...
            <main className="flex-1 p-6 md:p-8 overflow-y-auto">
                ...
                {activeFilters ? (
                    ...
                    <div className="mt-10 flex flex-col items-center justify-center text-center text-gray-500 bg-white p-10 rounded-lg shadow">
                        ...
                        <p className="mt-2">Please upload a crime data CSV file using the sidebar to begin the analysis.</p>
                    </div>
                )}
            </main>
